...
export const HeroImage = {
  ...
  earn: "/earn_hero_bg.png",
  support: "/support_bg.png",
};

export const HeroContainerStyling = {
  main: "max-w-[1160px]",
  earn: "max-w-[1193px]",
  support: "max-w-[1109px]",
};

export const flexibility_text =
...
export const earn_requirements = [
